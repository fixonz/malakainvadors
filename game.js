...
function drawMenuScreen(deltaTime) {
    ...
    const enemyTypes = [ENEMY_TYPES.BASIC, ENEMY_TYPES.FAST, ENEMY_TYPES.T OUGH, ENEMY_TYPES.ZIGZAG, ENEMY_TYPES.CIRCULAR, ENEMY_TYPES.DIVING];
                ...
                if (
                    ...
                    if (enemy.health <= 0) {
                        ...
                        score += (enemy.type === ENEMY_TYPES.FAST ? 15 :
                            ...
                            enemy.type === ENEMY_TYPES.BOSS ? 100 : 10) * difficulty.multi plier;
                    }
                    hitSound.play();
                }
            });
